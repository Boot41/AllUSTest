...
from .views import JobViewSet, JobSearchView, JobDetailView, JobStatusUpdateView, JobApplicationView, CandidateApplicationsView, NotificationView, MarkNotificationAsReadView
...
urlpatterns = [
    ...
    path('api/employers/<int:employer_id>/notifications/', NotificationView.as_view(), name='employer-notifications'),
    path('api/employers/<int:employer_id>/notifications/<int:notification_id>/read/', MarkNotificationAsReadView.as_view(), name='mark-notification-read'),
]